...
میخوایم به طور بازگشتی تمام زیر مجموعه های مقدار های وکتور از `i` تا آخر رو بسازیم و به همراه مقادیر فعلی وکتور `Ans` خروجی بدیم. (یک سری مقادیر هستن توی وکتور `Ans` که در استیت های قبلی بازگشتی از خونه های `0` تا `currentCell - 1` پوش بک شدن) <br> 
