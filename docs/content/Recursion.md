...
میخوایم به طور بازگشتی تمام زیر مجموعه های مقدار های وکتور از `i` تا آخر رو بسازیم و به همراه مقادیر فعلی وکتور `Ans` خروجی بدیم. (یک سری مقادیر هستن توی وکتور `Ans` که در استیت های قبلی بازگشتی از خونه های `0` تا `i-1` پوش بک شدن) <br> 
...
- زیر مجموعه هایی که خونه `i` درونشون نباشه. <br>
    همون مثل حالت قبله فقط `i` رو از درون `Ans` پاپ بک میکنیم و میگیم دوباره برو و همه زیر مجموعه های از `i+1` تا آخر رو بدون وجود `i` درون اون زیر مجموعه ها خروجی بده . <br>
